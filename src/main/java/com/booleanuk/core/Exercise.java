...
public class Exercise extends ExerciseBase {
    ...
    public String shout(String string, int num) {
        String shout = string.toUpperCase();
        StringBuilder exclamationMark = new StringBuilder();
        exclamationMark.append("!".repeat(Math.max(0, num)));

        return shout + exclamationMark;
    }
